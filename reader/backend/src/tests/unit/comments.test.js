...
describe('CommentsService', () => {
  ...
  test('content empty', async () => {
    await expect(
      commentsService.addCommentToArticle(2, { content: '' })
    ).rejects.toThrow('Contenu obligatoire'); //"rejects" on s'atteend à l'erreur. .toThrow() ce que l'erreur doit indiquer
  });
